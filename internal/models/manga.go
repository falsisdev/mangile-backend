...
type Manga struct {
	...
	SanityCover        string                     `json:"sanity_cover,omitempty"`
	SanityTags         []string                   `json:"sanity_tags,omitempty"`
	SanityDataMissing  bool                       `json:"sanity_data_missing,omitempty"`
	AniListDataMissing bool                       `json:"anilist_data_missing,omitempty"`
	MalDataMissing     bool                       `json:"mal_data_missing,omitempty"`
	AniListID          int                        `json:"anilist_id,omitempty"`
	AnilistTitle       string                     `json:"anilist_title,omitempty"`
	AnilistScore       float64                    `json:"anilist_score,omitempty"`
	AnilistBanner      string                     `json:"anilist_banner,omitempty"`
	AnilistCover       string                     `json:"anilist_cover,omitempty"`
	AnilistTags        []interface{}              `json:"anilist_tags,omitempty"`
	AnilistDescription string                     `json:"anilist_description,omitempty"`
	AnilistTrending    int                        `json:"anilist_trending,omitempty"`
	AnilistSeasonYear  int                        `json:"anilist_season_year,omitempty"`
	AnilistRelations   AniListRelationsConnection `json:"anilist_relations,omitempty"`
	MalID              int                        `json:"mal_id,omitempty"`
	MalTitleJapanese   string                     `json:"title_japanese,omitempty"`
	MalTitleEnglish    string                     `json:"title_english,omitempty"`
	MalStatus          string                     `json:"mal_status,omitempty"`
	MalScore           float64                    `json:"mal_score,omitempty"`
	MalAuthors         []interface{}              `json:"mal_authors,omitempty"`
	MalGenres          []interface{}              `json:"mal_genres,omitempty"`
	MalThemes          []interface{}              `json:"mal_themes,omitempty"`
...
type LightNovel struct {
	...
	MalThemes          []interface{}              `json:"mal_themes,omitempty"`
	MalURL             string                     `json:"mal_url,omitempty"`
	Chapters           []LightNovelChapter        `json:"chapters,omitempty"`
	Notes              []interface{}              `json:"notes,omitempty"`
}
